    ...
    <div class="col-lg-7">
                                <div class="subcription-single-data-card">
                                    ...
                                    <div class="grid-button mt-4">
                                        <a href="#withdraw" class="btn btn-secondary" type="button"
                                            data-bs-toggle="modal">Withdraw</a>
                                        <span  v-if="!subscription_details_data.amendedInvestment" class="btn btn-warning" @click="investment_temp_store" type="button">Amend</span>
                                    </div>
...
export default {
    ...
    data(){
        return {
            ...
            subcription_type: this.$route.params.type
        }
    },
    created(){
