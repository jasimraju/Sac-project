				...
				<div class="modal-body">
					...
					<form class="d-grid" @submit.prevent="handleOtp" @keydown.enter="$event.preventDefault()">
						...
						<div class="note text-center mt-3">
							<p>It may take a minute to receive your code.<br /> Haven’t received? <a href="#">Resend a new
									code.</a></p>
						</div>
	...
	methods: {
		handleOtp() {
			...
			if (checkvalidtion) {
				...
				this.globalpostauth('userProfile/validate/mobile/otp?mobileNo=' + this.phone_number + '&otp=' + otp_valu).then((result) => {
