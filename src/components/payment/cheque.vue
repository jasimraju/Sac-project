        ...
        <div class="col-md-8 offset-md-2">
            <div class="subcription-form">
                <div class="share-payment-details">
                        ...
                        <div class="share-payment-cheque" v-if="account_details != null">
                            <h6>For payment by cashier’s order/cheques, kindly issue a cheque with the details as follows:
                            </h6>
                                ...
                                <table class="table table-striped">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <p>Issued To</p>
                                                <h5>{{ account_details.issuedTo }}</h5>
                                            </td>
                                        </tr>
                                        <tr>
