            ...
            <div class="subcription-form">
                <div class="share-payment-details">
                        ...
                        <div class="share-payment-details" v-if="account_details != null">
                            <h6>For payment by telegraphic transfer, kindly transfer the payment with the details as
                                follows:</h6>
                                ...
                                <table class="table table-striped">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <p>Account Name</p>
                                                <h5 v-if=" account_details != null">{{ account_details.accountName }}</h5>
                                            </td>

                                            <td>
                                                <p>Account Number</p>
                                                <h5 v-if=" account_details != null">{{ account_details.accountNumber }}</h5>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <p>Bank</p>
                                                <h5 v-if=" account_details != null">{{ account_details.bank }}</h5>
                                            </td>
                                            <td>
                                                <p>Bank Code</p>
                                                <h5 v-if=" account_details != null">{{ account_details.bankCode }}</h5>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <p>Bank Swift Code</p>
                                                <h5 v-if=" account_details != null">{{  account_details.bankSwiftCode }}</h5>
                                            </td>
                                            <td>
